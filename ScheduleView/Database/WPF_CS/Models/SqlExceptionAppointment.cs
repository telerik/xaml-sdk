            ...
            switch (e.Action)
            {
                ...
                case NotifyCollectionChangedAction.Remove:
                    foreach (var sqlres in e.OldItems.OfType<SqlResource>())
                    {
                        ...
                        {
                            itemsToRemove = sqlres.SqlExceptionResources.Where(x => x.SqlResources_SqlResourceId == sqlres.SqlResourceId && x.SqlExceptionAppointments_ExceptionId == this.ExceptionId).ToList();
                            foreach (var item in itemsToRemove)
                            {
