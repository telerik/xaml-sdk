...
namespace DateTimeGrouping
{
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
			...
			//this.radChart.DefaultView.ChartArea.AxisX.AutoRange = false;
			//this.radChart.DefaultView.ChartArea.AxisX.MinValue = itemsSource.Min(cd => cd.Date).ToOADate();
			//this.radChart.DefaultView.ChartArea.AxisX.MaxValue = itemsSource.Max(cd => cd.Date).ToOADate();
			//this.radChart.DefaultView.ChartArea.AxisX.Step = 30;
