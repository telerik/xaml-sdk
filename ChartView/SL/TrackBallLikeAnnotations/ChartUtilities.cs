...
namespace TrackBallLikeAnnotations
{
    public class ChartUtilities
    {
        ...
        static void Border_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            { 
                border.DataContextChanged -= Border_DataContextChanged;
                border.Measure(new Size(double.PositiveInfinity, double.PositiveInfinity));
                border.Margin = new Thickness(-border.DesiredSize.Width / 2, 0, border.DesiredSize.Width / 2, 0);
            });
        }
