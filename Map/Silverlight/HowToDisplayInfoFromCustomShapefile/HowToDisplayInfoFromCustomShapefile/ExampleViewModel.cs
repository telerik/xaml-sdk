...
namespace HowToDisplayInfoFromCustomShapefile
{
    ...
    {
        private const string ShapeRelativeUriFormat = "/HowToDisplayInfoFromCustomShapefile;component/Resources/{0}";
        private const string StadiumViewImageUriFormat = "/HowToDisplayInfoFromCustomShapefile;component/Images/{0}";
